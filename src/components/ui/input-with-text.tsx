...
const InputWithText: React.FC<InputWithTextProps> = ({ label, id, rootClassName,  className, ...props }) => {
  return (
    <div className={cn(`${className} flex items-center gap-3 mb-2  bg-accent rounded-lg focus-within:ring-offset-2 focus-within:ring-2 ring-offset-custom-slate ring-primary`, rootClassName)}>
