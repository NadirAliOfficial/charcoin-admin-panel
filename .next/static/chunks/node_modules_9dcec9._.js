(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_9dcec9._.js", {
...
__turbopack_esm__({
    ...
    "CmcdTypeValues": (()=>Ft),
    "CmcdTypes": (()=>w),
    "ExtensionMimeTypeMap": (()=>L),
    "Hls": (()=>E),
    "MaxResolution": (()=>Wt),
    "MediaError": (()=>T),
    "MimeTypeShorthandMap": (()=>F),
    "MinResolution": (()=>$t),
    "MuxErrorCategory": (()=>x),
    "MuxErrorCode": (()=>R),
    "MuxJWTAud": (()=>ae),
    ...
    "addTextTrack": (()=>re),
    "allMediaTypes": (()=>Yt),
    "errorCategoryToTokenNameOrPrefix": (()=>H),
    "generatePlayerInitTime": (()=>wr),
    "generateUUID": (()=>Rt),
    "getActiveChapter": (()=>Le),
    "getActiveCuePoint": (()=>_e),
    "getAppCertificate": (()=>Nt),
    "getChapters": (()=>ot),
    "getCuePoints": (()=>nt),
    "getCurrentPdt": (()=>st),
    "getDRMConfig": (()=>Lt),
    ...
    "getLicenseKey": (()=>It),
    "getLiveEdgeStart": (()=>Hr),
    "getMediaPlaylistLinesFromMultivariantPlaylistSrc": (()=>dt),
    "getSeekable": (()=>We),
    "getStartDate": (()=>at),
    "getStreamInfoFromHlsjsLevelDetails": (()=>Tt),
    "getStreamInfoFromPlaylistLines": (()=>lt),
    "getStreamInfoFromSrcAndType": (()=>pt),
    "getStreamType": (()=>Se),
    "getStreamTypeConfig": (()=>ht),
    "getTargetLiveWindow": (()=>Ur),
    "getTextTrack": (()=>A),
    "i18n": (()=>g),
    "initialize": (()=>Vr),
    "isKeyOf": (()=>S),
    ...
    "setupHls": (()=>kt),
    "setupMux": (()=>St),
    "setupNativeFairplayDRM": (()=>At),
    "shorthandKeys": (()=>Kt),
    "teardown": (()=>Pt),
    "toAppCertURL": (()=>Ge),
    "toDRMTypeFromKeySystem": (()=>ut),
    "toLicenseKeyURL": (()=>G),
    "toMuxVideoURL": (()=>Or),
    "toPlaybackIdFromSrc": (()=>xt),
    "toPlaybackIdParts": (()=>Y),
    "updateStreamInfoFromHlsjsLevelDetails": (()=>yt),
    "updateStreamInfoFromSrc": (()=>ft)
});
...
}, H = (e)=>e === x.VIDEO ? "playback" : e, k = class k extends Error {
    constructor(t, r = k.MEDIA_ERR_CUSTOM, n, o){
        var a;
        super(t), this.name = "MediaError", this.code = r, this.context = o, this.fatal = n != null ? n : r >= k.MEDIA_ERR_NETWORK && r <= k.MEDIA_ERR_ENCRYPTED, this.message || (this.message = (a = k.defaultMessages[this.code]) != null ? a : "");
    }
};
k.MEDIA_ERR_ABORTED = 1, k.MEDIA_ERR_NETWORK = 2, k.MEDIA_ERR_DECODE = 3, k.MEDIA_ERR_SRC_NOT_SUPPORTED = 4, k.MEDIA_ERR_ENCRYPTED = 5, k.MEDIA_ERR_CUSTOM = 100, k.defaultMessages = {
...
var T = k;
var Qe = (e)=>e == null, S = (e, t)=>Qe(t) ? !1 : e in t, V = {
    ANY: "any",
    MUTED: "muted"
}, P = {
    ON_DEMAND: "on-demand",
...
var Y = (e)=>{
    ...
    let { src: r } = e;
    return r ? et(r) : "";
}, X = (e)=>e === "VOD" ? P.ON_DEMAND : P.LIVE, Q = (e)=>e === "EVENT" ? Number.POSITIVE_INFINITY : e === "VOD" ? Number.NaN : 0, et = (e)=>{
    let t = "";
    try {
...
}, fe = ({ exp: e }, t = Date.now())=>!e || e * 1e3 < t, Te = ({ sub: e }, t)=>e !== t, ye = ({ aud: e }, t)=>!e, me = ({ aud: e }, t)=>e !== t, Ee = "en";
function g(e, t = !0) {
    var o, a;
    let r = t && (a = (o = K) == null ? void 0 : o[e]) != null ? a : e, n = t ? K.code : Ee;
    return new z(r, n);
}
var z = class {
    constructor(t, r = ((n)=>(n = K) != null ? n : Ee)()){
...
var tt = Object.values(V), ge = (e)=>typeof e == "boolean" || typeof e == "string" && tt.includes(e), Me = (e, t, r)=>{
    let { autoplay: n } = e, o = !1, a = !1, s = ge(n) ? n : !!n, u = ()=>{
        o || C(t, "playing", ()=>{
            o = !0;
        }, {
            once: !0
    ...
    if (u(), C(t, "loadstart", ()=>{
        ...
        r || (e.streamType && e.streamType !== P.UNKNOWN ? a = e.streamType === P.LIVE : a = !Number.isFinite(t.duration)), ee(t, s);
    }, {
        once: !0
    }), r && r.once(E.Events.LEVEL_LOADED, (c, i)=>{
        var d;
        e.streamType && e.streamType !== P.UNKNOWN ? a = e.streamType === P.LIVE : a = (d = i.details.live) != null ? d : !1;
    }), !s) {
        let c = ()=>{
        ...
        r && C(t, "play", ()=>{
            t.preload === "metadata" ? r.once(E.Events.LEVEL_UPDATED, c) : c();
        }, {
            once: !0
        });
    }
...
var Re = ({ preload: e, src: t }, r, n)=>{
    let o = (d)=>{
        d != null && [
            ...
            "metadata",
            "auto"
        ].includes(d) ? r.setAttribute("preload", d) : r.removeAttribute("preload");
    };
    if (!n) return o(e), o;
    let a = !1, s = !1, u = n.config.maxBufferLength, l = n.config.maxBufferSize, c = (d)=>{
        o(d);
        let p = d != null ? d : r.preload;
        s || p === "none" || (p === "metadata" ? (n.config.maxBufferLength = 1, n.config.maxBufferSize = 1) : (n.config.maxBufferLength = u, n.config.maxBufferSize = l), i());
    }, i = ()=>{
        !a && t && (a = !0, n.loadSource(t));
    };
    return C(r, "play", ()=>{
        s = !0, n.config.maxBufferLength = u, n.config.maxBufferSize = l, i();
    }, {
        once: !0
    }), c(e), c;
};
function xe(e, t) {
    ...
    let r = new WeakMap;
    t.on(E.Events.MANIFEST_PARSED, function(c, i) {
        u();
        let d = e.addVideoTrack("main");
        d.selected = !0;
        for (let [p, f] of i.levels.entries()){
            let y = d.addRendition(f.url[0], f.width, f.height, f.videoCodec, f.bitrate);
            r.set(f, `${p}`), y.id = `${p}`;
        }
    }), t.on(E.Events.AUDIO_TRACKS_UPDATED, function(c, i) {
        s();
        for (let d of i.audioTracks){
            let p = d.default ? "main" : "alternative", f = e.addAudioTrack(p, d.name, d.lang);
            f.id = `${d.id}`, d.default && (f.enabled = !0);
        }
    }), e.audioTracks.addEventListener("change", ()=>{
        var d;
        let c = +((d = [
            ...e.audioTracks
        ].find((p)=>p.enabled)) == null ? void 0 : d.id), i = t.audioTracks.map((p)=>p.id);
        c != t.audioTrack && i.includes(c) && (t.audioTrack = c);
    }), t.on(E.Events.LEVELS_UPDATED, function(c, i) {
        var f;
        let d = e.videoTracks[(f = e.videoTracks.selectedIndex) != null ? f : 0];
        if (!d) return;
        let p = i.levels.map((y)=>r.get(y));
        for (let y of e.videoRenditions)y.id && !p.includes(y.id) && d.removeRendition(y);
    });
    let n = (c)=>{
        let i = c.target.selectedIndex;
        i != t.nextLevel && o(i);
    }, o = (c)=>{
        let i = e.currentTime, d = !1, p = (f, y)=>{
            d || (d = !Number.isFinite(y.endOffset));
        };
        t.on(E.Events.BUFFER_FLUSHING, p), t.nextLevel = c, t.off(E.Events.BUFFER_FLUSHING, p), d || t.trigger(E.Events.BUFFER_FLUSHING, {
            startOffset: i + 10,
            endOffset: 1 / 0,
            type: "video"
        });
    };
    (l = e.videoRenditions) == null || l.addEventListener("change", n);
    let a = ()=>{
    ...
    t.once(E.Events.DESTROYING, u);
}
var te = (e)=>"time" in e ? e.time : e.startTime;
function be(e, t) {
    t.on(E.Events.NON_NATIVE_TEXT_TRACKS_FOUND, (o, { tracks: a })=>{
        a.forEach((s)=>{
            var i, d;
            let u = (i = s.subtitleTrack) != null ? i : s.closedCaptions, l = t.subtitleTracks.findIndex(({ lang: p, name: f, type: y })=>p == (u == null ? void 0 : u.lang) && f === s.label && y.toLowerCase() === s.kind), c = ((d = s._id) != null ? d : s.default) ? "default" : `${s.kind}${l}`;
            re(e, s.kind, s.label, u == null ? void 0 : u.lang, c, s.default);
        });
    });
    let r = ()=>{
        if (!t.subtitleTracks.length) return;
        let o = Array.from(e.textTracks).find((u)=>u.id && u.mode === "showing" && [
                "subtitles",
                "captions"
            ].includes(u.kind));
        if (!o) return;
        let a = t.subtitleTracks[t.subtitleTrack], s = a ? a.default ? "default" : `${t.subtitleTracks[t.subtitleTrack].type.toLowerCase()}${t.subtitleTrack}` : void 0;
        if (t.subtitleTrack < 0 || (o == null ? void 0 : o.id) !== s) {
            let u = t.subtitleTracks.findIndex(({ lang: l, name: c, type: i, default: d })=>o.id === "default" && d || l == o.language && c === o.label && i.toLowerCase() === o.kind);
            t.subtitleTrack = u;
        }
        (o == null ? void 0 : o.id) === s && o.cues && Array.from(o.cues).forEach((u)=>{
            o.addCue(u);
        });
    };
    e.textTracks.addEventListener("change", r), t.on(E.Events.CUES_PARSED, (o, { track: a, cues: s })=>{
        let u = e.textTracks.getTrackById(a);
        if (!u) return;
        let l = u.mode === "disabled";
        l && (u.mode = "hidden"), s.forEach((c)=>{
            var i;
            (i = u.cues) != null && i.getCueById(c.id) || u.addCue(c);
        }), l && (u.mode = "disabled");
        ...
        Array.from(e.textTracks).forEach((o)=>{
            ...
            if (![
                ...
                if (!((a = o.cues) != null && a.length)) {
                    let u = "track";
                    o.kind && (u += `[kind="${o.kind}"]`), o.label && (u += `[label="${o.label}"]`);
                    let l = e.querySelector(u), c = (s = l == null ? void 0 : l.getAttribute("src")) != null ? s : "";
                    l == null || l.removeAttribute("src"), setTimeout(()=>{
                        l == null || l.setAttribute("src", c);
                    }, 0);
                }
...
function re(e, t, r, n, o, a) {
    ...
    return s.kind = t, s.label = r, n && (s.srclang = n), o && (s.id = o), a && (s.default = !0), s.track.mode = [
        "subtitles",
        "captions"
    ].includes(t) ? "disabled" : "hidden", s.setAttribute("data-removeondestroy", ""), e.append(s), s.track;
}
function rt(e, t) {
...
async function Ce(e, t, r, n) {
    let o = A(e, r, n);
    return o || (o = re(e, n, r), o.mode = "hidden", await new Promise((a)=>setTimeout(()=>a(void 0), 0))), o.mode !== "hidden" && (o.mode = "hidden"), [
        ...t
    ].sort((a, s)=>te(s) - te(a)).forEach((a)=>{
        var l, c;
        let s = a.value, u = te(a);
        if ("endTime" in a && a.endTime != null) o == null || o.addCue(new VTTCue(u, a.endTime, n === "chapters" ? s : JSON.stringify(s != null ? s : null)));
        else {
            let i = Array.prototype.findIndex.call(o == null ? void 0 : o.cues, (y)=>y.startTime >= u), d = (l = o == null ? void 0 : o.cues) == null ? void 0 : l[i], p = d ? d.startTime : Number.isFinite(e.duration) ? e.duration : Number.MAX_SAFE_INTEGER, f = (c = o == null ? void 0 : o.cues) == null ? void 0 : c[i - 1];
            f && (f.endTime = u), o == null || o.addCue(new VTTCue(u, p, n === "chapters" ? s : JSON.stringify(s != null ? s : null)));
        }
...
var ne = "cuepoints", De = Object.freeze({
    label: ne
});
async function ve(e, t, r = De) {
...
function nt(e, t = {
    ...
    let r = A(e, t.label, "metadata");
    return r != null && r.cues ? Array.from(r.cues, (n)=>W(n)) : [];
}
function _e(e, t = {
    label: ne
}) {
    ...
    if (r.activeCues.length === 1) return W(r.activeCues[0]);
    let { currentTime: n } = e, o = Array.prototype.find.call((s = r.activeCues) != null ? s : [], ({ startTime: u, endTime: l })=>u <= n && l > n);
    return W(o || r.activeCues[0]);
}
async function Pe(e, t = De) {
...
var oe = "chapters", ke = Object.freeze({
    label: oe
}), $ = (e)=>({
...
function ot(e, t = {
    ...
    var n;
    let r = A(e, t.label, "chapters");
    return (n = r == null ? void 0 : r.cues) != null && n.length ? Array.from(r.cues, (o)=>$(o)) : [];
}
function Le(e, t = {
    label: oe
}) {
...
var ae = {
    ...
    if (e === x.VIDEO) return ae.VIDEO;
    if (e === x.DRM) return ae.DRM;
}, ct = (e, t)=>{
    var o, a;
    let r = H(e), n = `${r}Token`;
    return (o = t.tokens) != null && o[r] ? (a = t.tokens) == null ? void 0 : a[r] : S(n, t) ? t[n] : void 0;
}, U = (e, t, r, n = !1, o = !((a)=>(a = globalThis.navigator) == null ? void 0 : a.onLine)())=>{
    var D, _;
    if (o) {
        let M = g("Your device appears to be offline", n), b = void 0, m = T.MEDIA_ERR_NETWORK, h = new T(M, m, !0, b);
        return h.errorCategory = t, h.muxCode = R.NETWORK_OFFLINE, h.data = e, h;
    }
    let s = "status" in e ? e.status : e.code, u = Date.now(), l = T.MEDIA_ERR_NETWORK;
    if (s === 200) return;
    let c = H(t), i = ct(t, r), d = it(t), [p] = Y((D = r.playbackId) != null ? D : "");
    if (!s || !p) return;
    let f = Z(i);
    if (i && !f) {
        let M = g("The {tokenNamePrefix}-token provided is invalid or malformed.", n).format({
            tokenNamePrefix: c
        }), b = g("Compact JWT string: {token}", n).format({
            token: i
        }), m = new T(M, l, !0, b);
        return m.errorCategory = t, m.muxCode = R.NETWORK_TOKEN_MALFORMED, m.data = e, m;
    }
    if (s >= 500) {
        let M = new T("", l, !0);
        return M.errorCategory = t, M.muxCode = R.NETWORK_UNKNOWN_ERROR, M;
    }
    if (s === 403) if (f) {
        if (fe(f, u)) {
            let M = {
                timeStyle: "medium",
                dateStyle: "medium"
            }, b = g("The video\u2019s secured {tokenNamePrefix}-token has expired.", n).format({
                tokenNamePrefix: c
            }), m = g("Expired at: {expiredDate}. Current time: {currentDate}.", n).format({
                expiredDate: new Intl.DateTimeFormat("en", M).format((_ = f.exp) != null ? _ : 0 * 1e3),
                currentDate: new Intl.DateTimeFormat("en", M).format(u)
            }), h = new T(b, l, !0, m);
            return h.errorCategory = t, h.muxCode = R.NETWORK_TOKEN_EXPIRED, h.data = e, h;
        }
        if (Te(f, p)) {
            let M = g("The video\u2019s playback ID does not match the one encoded in the {tokenNamePrefix}-token.", n).format({
                tokenNamePrefix: c
            }), b = g("Specified playback ID: {playbackId} and the playback ID encoded in the {tokenNamePrefix}-token: {tokenPlaybackId}", n).format({
                tokenNamePrefix: c,
                playbackId: p,
                tokenPlaybackId: f.sub
            }), m = new T(M, l, !0, b);
            return m.errorCategory = t, m.muxCode = R.NETWORK_TOKEN_SUB_MISMATCH, m.data = e, m;
        }
        if (ye(f, d)) {
            let M = g("The {tokenNamePrefix}-token is formatted with incorrect information.", n).format({
                tokenNamePrefix: c
            }), b = g("The {tokenNamePrefix}-token has no aud value. aud value should be {expectedAud}.", n).format({
                tokenNamePrefix: c,
                expectedAud: d
            }), m = new T(M, l, !0, b);
            return m.errorCategory = t, m.muxCode = R.NETWORK_TOKEN_AUD_MISSING, m.data = e, m;
        }
        if (me(f, d)) {
            let M = g("The {tokenNamePrefix}-token is formatted with incorrect information.", n).format({
                tokenNamePrefix: c
            }), b = g("The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.", n).format({
                tokenNamePrefix: c,
                expectedAud: d,
                aud: f.aud
            }), m = new T(M, l, !0, b);
            return m.errorCategory = t, m.muxCode = R.NETWORK_TOKEN_AUD_MISMATCH, m.data = e, m;
        }
    } else {
        let M = g("Authorization error trying to access this {category} URL. If this is a signed URL, you might need to provide a {tokenNamePrefix}-token.", n).format({
            tokenNamePrefix: c,
            category: t
        }), b = g("Specified playback ID: {playbackId}", n).format({
            playbackId: p
        }), m = new T(M, l, !0, b);
        return m.errorCategory = t, m.muxCode = R.NETWORK_TOKEN_MISSING, m.data = e, m;
    }
    if (s === 412) {
        let M = g("This playback-id may belong to a live stream that is not currently active or an asset that is not ready.", n), b = g("Specified playback ID: {playbackId}", n).format({
            playbackId: p
        }), m = new T(M, l, !0, b);
        return m.errorCategory = t, m.muxCode = R.NETWORK_NOT_READY, m.data = e, m;
    }
    if (s === 404) {
        let M = g("This URL or playback-id does not exist. You may have used an Asset ID or an ID from a different resource.", n), b = g("Specified playback ID: {playbackId}", n).format({
            playbackId: p
        }), m = new T(M, l, !0, b);
        return m.errorCategory = t, m.muxCode = R.NETWORK_NOT_FOUND, m.data = e, m;
    }
    if (s === 400) {
        let M = g("The URL or playback-id was invalid. You may have used an invalid value as a playback-id."), b = g("Specified playback ID: {playbackId}", n).format({
            playbackId: p
        }), m = new T(M, l, !0, b);
        return m.errorCategory = t, m.muxCode = R.NETWORK_INVALID_URL, m.data = e, m;
    }
    let y = new T("", l, !0);
    return y.errorCategory = t, y.muxCode = R.NETWORK_UNKNOWN_ERROR, y.data = e, y;
};
var Ie = E.DefaultConfig.capLevelController, B = class B extends Ie {
    constructor(t){
        super(t);
    }
    get levels() {
    ...
    getMaxLevel(t) {
        ...
        if (!n[r]) return r;
        let o = Math.min(n[r].width, n[r].height), a = B.minMaxResolution;
        return o >= a ? r : Ie.getMaxLevelByMediaSize(n, a * (16 / 9), a);
    }
};
B.minMaxResolution = 720;
var se = B, Ae = se;
var J = {
    FAIRPLAY: "fairplay",
    PLAYREADY: "playready",
...
}, dt = async (e)=>fetch(e).then((t)=>t.status !== 200 ? Promise.reject(t) : t.text()).then((t)=>{
        let r = t.split(`
`).find((n, o, a)=>o && a[o - 1].startsWith("#EXT-X-STREAM-INF"));
        return fetch(r).then((n)=>n.status !== 200 ? Promise.reject(n) : n.text()).then((n)=>n.split(`
`));
    }), lt = (e)=>{
    var s, u, l;
    let r = (u = ((s = e.find((c)=>c.startsWith("#EXT-X-PLAYLIST-TYPE"))) != null ? s : "").split(":")[1]) == null ? void 0 : u.trim(), n = X(r), o = Q(r), a;
    if (n === P.LIVE) {
        let c = e.find((d)=>d.startsWith("#EXT-X-PART-INF"));
        if (!!c) a = +c.split(":")[1].split("=")[1] * 2;
        else {
            let d = e.find((y)=>y.startsWith("#EXT-X-TARGETDURATION")), p = (l = d == null ? void 0 : d.split(":")) == null ? void 0 : l[1];
            a = +(p != null ? p : 6) * 3;
        }
    }
    return {
    ...
    var s, u, l;
    let { streamType: n, targetLiveWindow: o, liveEdgeStartOffset: a } = await pt(e, r);
    ((s = v.get(t)) != null ? s : {}).liveEdgeStartOffset = a, ((u = v.get(t)) != null ? u : {}).targetLiveWindow = o, t.dispatchEvent(new CustomEvent("targetlivewindowchange", {
        composed: !0,
        bubbles: !0
    })), ((l = v.get(t)) != null ? l : {}).streamType = n, t.dispatchEvent(new CustomEvent("streamtypechange", {
        composed: !0,
        bubbles: !0
    }));
}, Tt = (e)=>{
    var s;
    let t = e.type, r = X(t), n = Q(t), o, a = !!((s = e.partList) != null && s.length);
    return r === P.LIVE && (o = a ? e.partTarget * 2 : e.targetduration * 3), {
        streamType: r,
        targetLiveWindow: n,
    ...
    var u, l, c, i, d, p, f, y;
    let { streamType: n, targetLiveWindow: o, liveEdgeStartOffset: a, lowLatency: s } = Tt(e);
    if (n === P.LIVE) {
        s ? (r.config.backBufferLength = (u = r.userConfig.backBufferLength) != null ? u : 4, r.config.maxFragLookUpTolerance = (l = r.userConfig.maxFragLookUpTolerance) != null ? l : .001, r.config.abrBandWidthUpFactor = (c = r.userConfig.abrBandWidthUpFactor) != null ? c : r.config.abrBandWidthFactor) : r.config.backBufferLength = (i = r.userConfig.backBufferLength) != null ? i : 8;
        let D = Object.freeze({
            get length () {
            ...
            start (_) {
                ...
                var M;
                return _ > this.length || _ < 0 || Number.isFinite(t.duration) ? t.seekable.end(_) : (M = r.liveSyncPosition) != null ? M : t.seekable.end(_);
            }
        });
        ((d = v.get(t)) != null ? d : {}).seekable = D;
    }
    ((p = v.get(t)) != null ? p : {}).liveEdgeStartOffset = a, ((f = v.get(t)) != null ? f : {}).targetLiveWindow = o, t.dispatchEvent(new CustomEvent("targetlivewindowchange", {
        composed: !0,
        bubbles: !0
    })), ((y = v.get(t)) != null ? y : {}).streamType = n, t.dispatchEvent(new CustomEvent("streamtypechange", {
        composed: !0,
        bubbles: !0
    }));
}, we, Oe, mt = (Oe = (we = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : we.userAgent) != null ? Oe : "", Ue, He, Ve, Et = (Ve = (He = (Ue = globalThis == null ? void 0 : globalThis.navigator) == null ? void 0 : Ue.userAgentData) == null ? void 0 : He.platform) != null ? Ve : "", gt = mt.toLowerCase().includes("android") || [
    "x11",
    "android"
].some((e)=>Et.toLowerCase().includes(e)), v = new WeakMap, I = "mux.com", Fe, Ke, Ye = (Ke = (Fe = E).isSupported) == null ? void 0 : Ke.call(Fe), Mt = gt, wr = ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mux$2d$embed$2f$dist$2f$mux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].utils.now(), Rt = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mux$2d$embed$2f$dist$2f$mux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].utils.generateUUID, Or = ({ playbackId: e, customDomain: t = I, maxResolution: r, minResolution: n, renditionOrder: o, programStartTime: a, programEndTime: s, assetStartTime: u, assetEndTime: l, playbackToken: c, tokens: { playback: i = c } = {}, extraSourceParams: d = {} } = {})=>{
    if (!e) return;
    let [p, f = ""] = Y(e), y = new URL(`https://stream.${t}/${p}.m3u8${f}`);
    return i || y.searchParams.has("token") ? (y.searchParams.forEach((D, _)=>{
        _ != "token" && y.searchParams.delete(_);
    }), i && y.searchParams.set("token", i)) : (r && y.searchParams.set("max_resolution", r), n && (y.searchParams.set("min_resolution", n), r && +r.slice(0, -1) < +n.slice(0, -1) && console.error("minResolution must be <= maxResolution", "minResolution", n, "maxResolution", r)), o && y.searchParams.set("rendition_order", o), a && y.searchParams.set("program_start_time", `${a}`), s && y.searchParams.set("program_end_time", `${s}`), u && y.searchParams.set("asset_start_time", `${u}`), l && y.searchParams.set("asset_end_time", `${l}`), Object.entries(d).forEach(([D, _])=>{
        _ != null && y.searchParams.set(D, _);
    })), y.toString();
}, j = (e)=>{
    if (!e) return;
    let [t] = e.split("?");
    ...
    var t, r, n;
    return (t = e == null ? void 0 : e.metadata) != null && t.video_id ? e.metadata.video_id : je(e) && (n = (r = j(e.playbackId)) != null ? r : xt(e.src)) != null ? n : e.src;
}, Ct = (e)=>{
    var t;
    return (t = v.get(e)) == null ? void 0 : t.error;
}, Se = (e)=>{
    var t, r;
    return (r = (t = v.get(e)) == null ? void 0 : t.streamType) != null ? r : P.UNKNOWN;
}, Ur = (e)=>{
    var t, r;
    return (r = (t = v.get(e)) == null ? void 0 : t.targetLiveWindow) != null ? r : Number.NaN;
}, We = (e)=>{
    var t, r;
    return (r = (t = v.get(e)) == null ? void 0 : t.seekable) != null ? r : e.seekable;
}, Hr = (e)=>{
    var n;
    let t = (n = v.get(e)) == null ? void 0 : n.liveEdgeStartOffset;
    if (typeof t != "number") return Number.NaN;
    let r = We(e);
    return r.length ? r.end(r.length - 1) - t : Number.NaN;
}, ue = .034, Dt = (e, t, r = ue)=>Math.abs(e - t) <= r, $e = (e, t, r = ue)=>e > t || Dt(e, t, r), vt = (e, t = ue)=>e.paused && $e(e.currentTime, e.duration, t), Be = (e, t)=>{
    var c, i, d;
    if (!t || !e.buffered.length) return;
    if (e.readyState > 2) return !1;
    let r = t.currentLevel >= 0 ? (i = (c = t.levels) == null ? void 0 : c[t.currentLevel]) == null ? void 0 : i.details : (d = t.levels.find((p)=>!!p.details)) == null ? void 0 : d.details;
    if (!r || r.live) return;
    let { fragments: n } = r;
    ...
    let a = o.start + o.duration / 2, s = e.buffered.start(e.buffered.length - 1), u = e.buffered.end(e.buffered.length - 1);
    return a > s && a < u;
}, _t = (e, t)=>e.ended || e.loop ? e.ended : t && Be(e, t) ? !0 : vt(e), Vr = (e, t, r)=>{
    Pt(t, r);
    let { metadata: n = {} } = e, { view_session_id: o = Rt() } = n, a = bt(e);
    ...
    e.drmTypeCb = s, v.set(t, {});
    let u = kt(e, t), l = Re(e, t, u);
    St(e, t, u), wt(e, t, u), Pe(t), Ne(t);
    let c = Me(e, t, u);
    return {
        engine: u,
        setAutoplay: c,
    ...
    r && (r.detachMedia(), r.destroy()), e != null && e.mux && !e.mux.deleted && (e.mux.destroy(), delete e.mux), e && (e.removeAttribute("src"), e.load(), e.removeEventListener("error", ze), e.removeEventListener("error", ie), e.removeEventListener("durationchange", qe), v.delete(e), e.dispatchEvent(new Event("teardown")));
};
function Je(e, t) {
    var c;
    let r = O(e);
    if (!(r === L.M3U8)) return !0;
    let o = !r || ((c = t.canPlayType(r)) != null ? c : !0), { preferPlayback: a } = e, s = a === q.MSE, u = a === q.NATIVE;
    return o && (u || !(Ye && (s || Mt)));
}
var kt = (e, t)=>{
    let { debug: r, streamType: n, startTime: o = -1, metadata: a, preferCmcd: s, _hlsConfig: u = {} } = e, c = O(e) === L.M3U8, i = Je(e, t);
    if (c && !i && Ye) {
        let d = {
            backBufferLength: 30,
            ...
            capLevelOnFPSDrop: !0
        }, p = ht(n), f = Lt(e), y = s !== w.NONE ? {
            useHeaders: s === w.HEADER,
        ...
        return new E({
            ...
            xhrSetup: (_, M)=>{
                var h, de;
                if (s && s !== w.QUERY) return;
                let b = new URL(M);
                if (!b.searchParams.has("CMCD")) return;
                let m = ((de = (h = b.searchParams.get("CMCD")) == null ? void 0 : h.split(",")) != null ? de : []).filter((le)=>le.startsWith("sid") || le.startsWith("cid")).join(",");
                b.searchParams.set("CMCD", m), _.open("GET", b);
            },
    ...
    let { tokens: { drm: t } = {}, playbackId: r, drmTypeCb: n } = e, o = j(r);
    return !t || !o ? {} : {
        emeEnabled: !0,
        drmSystems: {
            "com.apple.fps": {
        ...
        requestMediaKeySystemAccessFunc: (a, s)=>(a === "com.widevine.alpha" && (s = [
                ...s.map((u)=>{
                    var c;
                    let l = (c = u.videoCapabilities) == null ? void 0 : c.map((i)=>({
                            ...i,
                ...
                ...s
            ]), navigator.requestMediaKeySystemAccess(a, s).then((u)=>{
                let l = ut(a);
                return n == null || n(l), u;
            }))
    };
        ...
        try {
            ...
            if (!t.mediaKeys) {
                let c = await navigator.requestMediaKeySystemAccess("com.apple.fps", [
                    ...
                    var p;
                    return (p = e.drmTypeCb) == null || p.call(e, J.FAIRPLAY), d;
                }).catch(()=>{
                    let d = g("Cannot play DRM-protected content with current security configuration on this browser. Try playing in another browser."), p = new T(d, T.MEDIA_ERR_ENCRYPTED, !0);
                    p.errorCategory = x.DRM, p.muxCode = R.ENCRYPTED_UNSUPPORTED_KEY_SYSTEM, N(t, p);
                });
                if (!c) return;
                let i = await c.createMediaKeys();
                try {
                    let d = await Nt(Ge(e, "fairplay")).catch((p)=>{
                    ...
                    await i.setServerCertificate(d).catch(()=>{
                        let p = g("Your server certificate failed when attempting to set it. This may be an issue with a no longer valid certificate."), f = new T(p, T.MEDIA_ERR_ENCRYPTED, !0);
                        return f.errorCategory = x.DRM, f.muxCode = R.ENCRYPTED_UPDATE_SERVER_CERT_FAILED, Promise.reject(f);
                    });
                } catch (d) {
                    N(t, d);
                    return;
                }
                await t.setMediaKeys(i);
            }
            let a = n.initData;
            if (a == null) {
            ...
            let s = t.mediaKeys.createSession();
            s.addEventListener("keystatuseschange", ()=>{
                s.keyStatuses.forEach((c)=>{
                    let i;
                    if (c === "internal-error") {
                        let d = g("The DRM Content Decryption Module system had an internal failure. Try reloading the page, upading your browser, or playing in another browser.");
                        i = new T(d, T.MEDIA_ERR_ENCRYPTED, !0), i.errorCategory = x.DRM, i.muxCode = R.ENCRYPTED_CDM_ERROR;
                    } else if (c === "output-restricted" || c === "output-downscaled") {
                        let d = g("DRM playback is being attempted in an environment that is not sufficiently secure. User may see black screen.");
                        i = new T(d, T.MEDIA_ERR_ENCRYPTED, !1), i.errorCategory = x.DRM, i.muxCode = R.ENCRYPTED_OUTPUT_RESTRICTED;
                    }
                    i && N(t, i);
                });
            });
            let u = await Promise.all([
                s.generateRequest(o, a).catch(()=>{
                    let c = g("Failed to generate a DRM license request. This may be an issue with the player or your protected content."), i = new T(c, T.MEDIA_ERR_ENCRYPTED, !0);
                    i.errorCategory = x.DRM, i.muxCode = R.ENCRYPTED_GENERATE_REQUEST_FAILED, N(t, i);
                }),
                new Promise((c)=>{
            ...
            ]).then(([, c])=>c), l = await It(u, G(e, "fairplay")).catch((c)=>{
            ...
            await s.update(l).catch(()=>{
                let c = g("Failed to update DRM license. This may be an issue with the player or your protected content."), i = new T(c, T.MEDIA_ERR_ENCRYPTED, !0);
                return i.errorCategory = x.DRM, i.muxCode = R.ENCRYPTED_UPDATE_LICENSE_FAILED, Promise.reject(i);
            });
        } catch (o) {
            N(t, o);
            return;
...
}, je = ({ playbackId: e, src: t, customDomain: r })=>{
    if (e) return !0;
    ...
    var s;
    let { envKey: n, disableTracking: o } = e, a = je(e);
    if (!o && (n || a)) {
        let { playerInitTime: u, playerSoftwareName: l, playerSoftwareVersion: c, beaconCollectionDomain: i, debug: d, disableCookies: p } = e, f = {
            ...e.metadata,
            video_title: ((s = e == null ? void 0 : e.metadata) == null ? void 0 : s.video_title) || void 0
        }, y = (D)=>typeof D.player_error_code == "string" ? !1 : typeof e.errorTranslator == "function" ? e.errorTranslator(D) : D;
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mux$2d$embed$2f$dist$2f$mux$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].monitor(t, {
            debug: d,
            beaconCollectionDomain: i,
            hlsjs: r,
            Hls: r ? E : void 0,
    ...
    var c, i;
    let n = Je(e, t), { src: o } = e, a = ()=>{
        t.ended || !_t(t, r) || (Be(t, r) ? t.currentTime = t.buffered.end(t.buffered.length - 1) : t.dispatchEvent(new Event("ended")));
    }, s, u, l = ()=>{
        let d = We(t), p, f;
        d.length > 0 && (p = d.start(0), f = d.end(0)), (u !== f || s !== p) && t.dispatchEvent(new CustomEvent("seekablechange", {
            composed: !0
        })), s = p, u = f;
    };
    if (C(t, "durationchange", l), t && n) {
        let d = O(e);
        if (typeof o == "string") {
            let p = ()=>{
                if (Se(t) !== P.LIVE || Number.isFinite(t.duration)) return;
                let y = setInterval(l, 1e3);
                t.addEventListener("teardown", ()=>{
            ...
            }, f = async ()=>ft(o, t, d).then(p).catch((y)=>{
                    ...
                    } else y instanceof Error;
                });
            if (t.preload === "none") {
                let y = ()=>{
                    f(), t.removeEventListener("loadedmetadata", D);
                }, D = ()=>{
                    f(), t.removeEventListener("play", y);
                };
                C(t, "play", y, {
                    once: !0
                }), C(t, "loadedmetadata", D, {
                    once: !0
                });
            } else f();
            (c = e.tokens) != null && c.drm ? At(e, t) : C(t, "encrypted", ()=>{
                let y = g("Attempting to play DRM-protected content without providing a DRM token."), D = new T(y, T.MEDIA_ERR_ENCRYPTED, !0);
                D.errorCategory = x.DRM, D.muxCode = R.ENCRYPTED_MISSING_TOKEN, N(t, D);
            }, {
                once: !0
            }), t.setAttribute("src", o), e.startTime && (((i = v.get(t)) != null ? i : {}).startTime = e.startTime, t.addEventListener("durationchange", qe, {
                once: !0
            }));
        } else t.removeAttribute("src");
        t.addEventListener("error", ze), t.addEventListener("error", ie), t.addEventListener("emptied", ()=>{
            t.querySelectorAll("track[data-removeondestroy]").forEach((f)=>{
                f.remove();
            });
        }, {
            once: !0
        }), C(t, "pause", a), C(t, "seeked", a), C(t, "play", ()=>{
            t.ended || $e(t.currentTime, t.duration) && (t.currentTime = t.seekable.length ? t.seekable.start(0) : 0);
        });
    } else r && o ? (r.once(E.Events.LEVEL_LOADED, (d, p)=>{
        yt(p.details, t, r), l(), Se(t) === P.LIVE && !Number.isFinite(t.duration) && (r.on(E.Events.LEVEL_UPDATED, l), C(t, "durationchange", ()=>{
            Number.isFinite(t.duration) && r.off(E.Events.LEVELS_UPDATED, l);
        }));
    }), r.on(E.Events.ERROR, (d, p)=>{
        N(t, Ot(p, e));
    }), t.addEventListener("error", ie), C(t, "waiting", a), xe(e, r), be(t, r), r.attachMedia(t)) : console.error("It looks like the video you're trying to play will not work on this system! If possible, try upgrading to the newest versions of your browser or software.");
};
function qe(e) {
    var n;
    let t = e.target, r = (n = v.get(t)) == null ? void 0 : n.startTime;
    if (r && pe(t.seekable, t.duration, r)) {
...
async function ze(e) {
    ...
    if (t.src && n === T.MEDIA_ERR_SRC_NOT_SUPPORTED && t.readyState === HTMLMediaElement.HAVE_NOTHING) {
        setTimeout(()=>{
            var s;
            let a = (s = Ct(t)) != null ? s : t.error;
            (a == null ? void 0 : a.code) === T.MEDIA_ERR_SRC_NOT_SUPPORTED && N(t, o);
        }, 500);
        return;
    }
...
function N(e, t) {
    var r;
    t.fatal && (((r = v.get(e)) != null ? r : {}).error = t, e.dispatchEvent(new CustomEvent("error", {
        detail: t
    })));
}
function ie(e) {
    ...
    !r || !r.fatal || (((n = v.get(t)) != null ? n : {}).error = r, (o = t.mux) == null || o.emit("error", {
...
var Ot = (e, t)=>{
    ...
    let r = {
        ...
        ].includes(i.details) ? T.MEDIA_ERR_NETWORK : r[i.type], o = (i)=>{
        if (i.type === E.ErrorTypes.KEY_SYSTEM_ERROR) return x.DRM;
        if (i.type === E.ErrorTypes.NETWORK_ERROR) return x.VIDEO;
    }, a, s = n(e);
    if (s === T.MEDIA_ERR_NETWORK && e.response) {
        let i = (u = o(e)) != null ? u : x.VIDEO;
        a = (l = U(e.response, i, t)) != null ? l : new T("", s);
    } else if (s === T.MEDIA_ERR_ENCRYPTED) if (e.details === E.ErrorDetails.KEY_SYSTEM_NO_CONFIGURED_LICENSE) {
        let i = g("Attempting to play DRM-protected content without providing a DRM token.");
        a = new T(i, T.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = x.DRM, a.muxCode = R.ENCRYPTED_MISSING_TOKEN;
    } else if (e.details === E.ErrorDetails.KEY_SYSTEM_NO_ACCESS) {
        let i = g("Cannot play DRM-protected content with current security configuration on this browser. Try playing in another browser.");
        a = new T(i, T.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = x.DRM, a.muxCode = R.ENCRYPTED_UNSUPPORTED_KEY_SYSTEM;
    } else if (e.details === E.ErrorDetails.KEY_SYSTEM_NO_SESSION) {
        let i = g("Failed to generate a DRM license request. This may be an issue with the player or your protected content.");
        a = new T(i, T.MEDIA_ERR_ENCRYPTED, !0), a.errorCategory = x.DRM, a.muxCode = R.ENCRYPTED_GENERATE_REQUEST_FAILED;
    } else if (e.details === E.ErrorDetails.KEY_SYSTEM_SESSION_UPDATE_FAILED) {
        let i = g("Failed to update DRM license. This may be an issue with the player or your protected content.");
        a = new T(i, T.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = x.DRM, a.muxCode = R.ENCRYPTED_UPDATE_LICENSE_FAILED;
    } else if (e.details === E.ErrorDetails.KEY_SYSTEM_SERVER_CERTIFICATE_UPDATE_FAILED) {
        let i = g("Your server certificate failed when attempting to set it. This may be an issue with a no longer valid certificate.");
        a = new T(i, T.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = x.DRM, a.muxCode = R.ENCRYPTED_UPDATE_SERVER_CERT_FAILED;
    } else if (e.details === E.ErrorDetails.KEY_SYSTEM_STATUS_INTERNAL_ERROR) {
        let i = g("The DRM Content Decryption Module system had an internal failure. Try reloading the page, upading your browser, or playing in another browser.");
        a = new T(i, T.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = x.DRM, a.muxCode = R.ENCRYPTED_CDM_ERROR;
    } else if (e.details === E.ErrorDetails.KEY_SYSTEM_STATUS_OUTPUT_RESTRICTED) {
        let i = g("DRM playback is being attempted in an environment that is not sufficiently secure. User may see black screen.");
        a = new T(i, T.MEDIA_ERR_ENCRYPTED, !1), a.errorCategory = x.DRM, a.muxCode = R.ENCRYPTED_OUTPUT_RESTRICTED;
    } else a = new T(e.error.message, T.MEDIA_ERR_ENCRYPTED, e.fatal), a.errorCategory = x.DRM, a.muxCode = R.ENCRYPTED_ERROR;
    else a = new T("", s, e.fatal);
...
"[project]/node_modules/@mux/mux-video/node_modules/@mux/playback-core/dist/index.mjs [app-client] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var li = (e, i, t)=>i in e ? ci(e, i, {
        enumerable: !0,
        configurable: !0,
        writable: !0,
        value: t
    }) : e[i] = t;
var E = (e, i, t)=>li(e, typeof i != "symbol" ? i + "" : i, t), de = (e, i, t)=>i.has(e) || Ae("Cannot " + t);
var r = (e, i, t)=>(de(e, i, "read from private field"), t ? t.call(e) : i.get(e)), h = (e, i, t)=>i.has(e) ? Ae("Cannot add the same private member more than once") : i instanceof WeakSet ? i.add(e) : i.set(e, t), u = (e, i, t, s)=>(de(e, i, "write to private field"), s ? s.call(e, t) : i.set(e, t), t), y = (e, i, t)=>(de(e, i, "access private method"), t);
var Wt = (e, i, t)=>hi(ui(e), t, i);
var gt = class {
    addEventListener() {}
    removeEventListener() {}
    dispatchEvent(i) {
...
var Lt = class extends gt {
    ...
    constructor(i, t = {}){
        h(this, Mt);
        u(this, Mt, t == null ? void 0 : t.detail);
    }
    get detail() {
        return r(this, Mt);
    }
...
var ke = {
    ...
    HTMLElement: Lt,
    HTMLVideoElement: ce
}, Se = typeof window == "undefined" || typeof globalThis.customElements == "undefined", jt = Se ? ke : globalThis, Ji = Se ? ke.document : globalThis.document;
;
var pi = ()=>{
    try {
        return "0.24.5";
...
function we(e, { tag: i, is: t }) {
    var l, m, d, T, w, Ie, rt, a, p, R, k, ot, he, Oe, le, Le, Me;
    let s = (m = (l = globalThis.document) == null ? void 0 : l.createElement) == null ? void 0 : m.call(l, i, {
        is: t
    }), n = s ? bi(s) : [];
    return d = class extends e {
        ...
        static get observedAttributes() {
            var g, P, S;
            return y(g = d, w, Ie).call(g), [
                ...(S = (P = s == null ? void 0 : s.constructor) == null ? void 0 : P.observedAttributes) != null ? S : [],
                ...Pe
            ];
        }
        get nativeEl() {
            var f, g, P, S, A;
            return y(this, k, ot).call(this), (A = (S = (g = (f = r(this, a)) != null ? f : this.querySelector(":scope > [slot=media]")) != null ? g : this.querySelector(i)) != null ? S : (P = this.shadowRoot) == null ? void 0 : P.querySelector(i)) != null ? A : null;
        }
        set nativeEl(f) {
            u(this, a, f);
        }
        ...
        get preload() {
            var f, g;
            return (g = this.getAttribute("preload")) != null ? g : (f = this.nativeEl) == null ? void 0 : f.preload;
        }
        set preload(f) {
        ...
        init() {
            ...
            if (!this.shadowRoot) {
                ...
                let g = yi(this.attributes);
                t && (g.is = t), i && (g.part = i), this.shadowRoot.innerHTML = this.constructor.getTemplateHTML(g);
            }
            this.nativeEl.muted = this.hasAttribute("muted");
            for (let g of n)y(this, k, Le).call(this, g);
            u(this, R, new MutationObserver(y(this, k, Oe).bind(this))), this.shadowRoot.addEventListener("slotchange", this), y(this, k, he).call(this);
            for (let g of this.constructor.Events)(f = this.shadowRoot) == null || f.addEventListener(g, this, !0);
        }
        handleEvent(f) {
            if (f.type === "slotchange") {
                y(this, k, he).call(this);
                return;
            }
            f.target === this.nativeEl && this.dispatchEvent(new CustomEvent(f.type, {
                detail: f.detail
            }));
        }
        attributeChangedCallback(f, g, P) {
            y(this, k, ot).call(this), y(this, k, Me).call(this, f, g, P);
        }
        connectedCallback() {
            y(this, k, ot).call(this);
        }
    }, T = new WeakMap, w = new WeakSet, Ie = function() {
        if (r(this, T)) return;
        u(this, T, !0);
        let f = new Set(this.observedAttributes);
        f.delete("muted");
        for (let g of n)if (!(g in this.prototype)) if (typeof s[g] == "function") this.prototype[g] = function(...P) {
            return y(this, k, ot).call(this), (()=>{
                var I;
                if (this.call) return this.call(g, ...P);
                let A = (I = this.nativeEl) == null ? void 0 : I[g];
                return A == null ? void 0 : A.apply(this.nativeEl, P);
            })();
        };
        else {
            let P = {
                get () {
                    ...
                    let S = g.toLowerCase();
                    if (f.has(S)) {
                        let pt = this.getAttribute(S);
                        return pt === null ? !1 : pt === "" ? !0 : pt;
                    }
                    return (Ot = (A = this.get) == null ? void 0 : A.call(this, g)) != null ? Ot : (I = this.nativeEl) == null ? void 0 : I[g];
                }
            };
            g !== g.toUpperCase() && (P.set = function(S) {
                y(this, k, ot).call(this);
                let A = g.toLowerCase();
                if (f.has(A)) {
                    S === !0 || S === !1 || S == null ? this.toggleAttribute(A, !!S) : this.setAttribute(A, S);
                    return;
                }
                if (this.set) {
                    this.set(g, S);
                ...
                this.nativeEl && (this.nativeEl[g] = S);
            }), Object.defineProperty(this.prototype, g, P);
        }
    }, rt = new WeakMap, a = new WeakMap, p = new WeakMap, R = new WeakMap, k = new WeakSet, ot = function() {
        r(this, rt) || (u(this, rt, !0), this.init());
    }, he = function() {
        var S;
        let f = new Map(r(this, p)), g = (S = this.shadowRoot) == null ? void 0 : S.querySelector("slot:not([name])");
        (g == null ? void 0 : g.assignedElements({
            flatten: !0
        }).filter((A)=>[
                "track",
                "source"
            ].includes(A.localName))).forEach((A)=>{
            var Ot, pt;
            f.delete(A);
            let I = r(this, p).get(A);
            I || (I = A.cloneNode(), r(this, p).set(A, I), (Ot = r(this, R)) == null || Ot.observe(A, {
                attributes: !0
            })), (pt = this.nativeEl) == null || pt.append(I), y(this, k, le).call(this, I);
        }), f.forEach((A, I)=>{
            A.remove(), r(this, p).delete(I);
        });
    }, Oe = function(f) {
        var g;
        for (let P of f)if (P.type === "attributes") {
            let { target: S, attributeName: A } = P, I = r(this, p).get(S);
            I && A && (I.setAttribute(A, (g = S.getAttribute(A)) != null ? g : ""), y(this, k, le).call(this, I));
        }
    }, le = function(f) {
        f && f.localName === "track" && f.default && (f.kind === "chapters" || f.kind === "metadata") && f.track.mode === "disabled" && (f.track.mode = "hidden");
    }, Le = function(f) {
        if (Object.prototype.hasOwnProperty.call(this, f)) {
            let g = this[f];
            delete this[f], this[f] = g;
        }
    }, Me = function(f, g, P) {
        var S, A, I;
        [
            "id",
            "class"
        ].includes(f) || !d.observedAttributes.includes(f) && this.constructor.observedAttributes.includes(f) || (P === null ? (S = this.nativeEl) == null || S.removeAttribute(f) : ((A = this.nativeEl) == null ? void 0 : A.getAttribute(f)) !== P && ((I = this.nativeEl) == null || I.setAttribute(f, P)));
    }, h(d, w), E(d, "getTemplateHTML", i.endsWith("audio") ? Ei : Ti), E(d, "shadowRootOptions", {
        mode: "open"
    }), E(d, "Events", fe), h(d, T, !1), d;
}
function bi(e) {
    let i = [];
    for(let t = Object.getPrototypeOf(e); t && t !== HTMLElement.prototype; t = Object.getPrototypeOf(t)){
...
function yi(e) {
    let i = {};
    for (let t of e)i[t.name] = t.value;
    return i;
}
var Ce, $t = we((Ce = globalThis.HTMLElement) != null ? Ce : class {
}, {
    tag: "video"
}), _e, er = we((_e = globalThis.HTMLElement) != null ? _e : class {
}, {
    tag: "audio"
});
var D = new WeakMap, Et = class extends Error {
...
var vi = [
    ...
    "audio/mpegurl"
], xe = globalThis.WeakRef ? class extends Set {
    add(e) {
...
function De(e) {
    var i, t, s;
    (t = (i = globalThis.chrome) == null ? void 0 : i.cast) != null && t.isAvailable ? (s = globalThis.cast) != null && s.framework ? e() : customElements.whenDefined("google-cast-button").then(e) : globalThis.__onGCastApiAvailable = ()=>{
...
function Fe() {
    ...
    if ((t = globalThis.chrome) != null && t.cast || document.querySelector(`script[src="${e}"]`)) return;
    let i = document.createElement("script");
    i.src = e, document.head.append(i);
}
function U() {
    var e, i;
    return (i = (e = globalThis.cast) == null ? void 0 : e.framework) == null ? void 0 : i.CastContext.getInstance();
}
function wt() {
    var e;
    return (e = U()) == null ? void 0 : e.getCurrentSession();
}
function Xt() {
    var e;
    return (e = wt()) == null ? void 0 : e.getSessionObj().media[0];
}
function Ge(e) {
    return new Promise((i, t)=>{
        Xt().editTracksInfo(e, i, t);
    });
}
function Be(e) {
    return new Promise((i, t)=>{
...
function Ai(e) {
    if (!e) return;
    let i = /\.([a-zA-Z0-9]+)(?:\?.*)?$/, t = e.match(i);
    return t ? t[1] : null;
}
function ki(e) {
    let i = e.split(`
`), t = [];
    for(let s = 0; s < i.length; s++)if (i[s].trim().startsWith("#EXT-X-STREAM-INF")) {
        let l = i[s + 1] ? i[s + 1].trim() : "";
        l && !l.startsWith("#") && t.push(l);
    }
    return t;
}
function Si(e) {
    return e.split(`
`).find((s)=>!s.trim().startsWith("#") && s.trim() !== "");
}
async function Ke(e) {
    try {
        let t = (await fetch(e, {
        ...
        return vi.some((s)=>t === s);
    } catch (i) {
        return console.error("Error while trying to get the Content-Type of the manifest", i), !1;
    }
}
async function Ue(e) {
    try {
        let i = await (await fetch(e)).text(), t = i, s = ki(i);
        if (s.length > 0) {
            let m = new URL(s[0], e).toString();
            t = await (await fetch(m)).text();
        }
        let n = Si(t);
        return Ai(n);
    } catch (i) {
        console.error("Error while trying to parse the manifest playlist", i);
        return;
    }
}
var Jt = new xe, q = new WeakSet, L;
De(()=>{
    var e, i, t, s;
    if (!((i = (e = globalThis.chrome) == null ? void 0 : e.cast) != null && i.isAvailable)) {
        console.debug("chrome.cast.isAvailable", (s = (t = globalThis.chrome) == null ? void 0 : t.cast) == null ? void 0 : s.isAvailable);
        return;
    }
    L || (L = cast.framework, U().addEventListener(L.CastContextEventType.CAST_STATE_CHANGED, (n)=>{
        Jt.forEach((l)=>{
            var m, d;
            return (d = (m = D.get(l)).onCastStateChanged) == null ? void 0 : d.call(m, n);
        });
    }), U().addEventListener(L.CastContextEventType.SESSION_STATE_CHANGED, (n)=>{
        Jt.forEach((l)=>{
            var m, d;
            return (d = (m = D.get(l)).onSessionStateChanged) == null ? void 0 : d.call(m, n);
        });
    }), Jt.forEach((n)=>{
        var l, m;
        return (m = (l = D.get(n)).init) == null ? void 0 : m.call(l);
    }));
});
var qe = 0, v, Nt, M, V, dt, ct, Y, Qt, _, at, Ye, ge, He, Ee, We, Te, Zt = class extends EventTarget {
    constructor(t){
        super();
        h(this, _);
        h(this, v);
        ...
        h(this, M);
        h(this, V);
        h(this, dt, "disconnected");
        h(this, ct, !1);
        h(this, Y, new Set);
        h(this, Qt, new WeakMap);
        u(this, v, t), Jt.add(this), D.set(this, {
            init: ()=>y(this, _, Ee).call(this),
            onCastStateChanged: ()=>y(this, _, ge).call(this),
            onSessionStateChanged: ()=>y(this, _, He).call(this),
            getCastPlayer: ()=>r(this, _, at)
        }), y(this, _, Ee).call(this);
    }
    get state() {
        return r(this, dt);
    }
    async watchAvailability(t) {
        if (r(this, v).disableRemotePlayback) throw new Et("disableRemotePlayback attribute is present.");
        return r(this, Qt).set(t, ++qe), r(this, Y).add(t), qe;
    }
    async cancelWatchAvailability(t) {
        if (r(this, v).disableRemotePlayback) throw new Et("disableRemotePlayback attribute is present.");
        t ? r(this, Y).delete(t) : r(this, Y).clear();
    }
    async prompt() {
        var s, n, l, m;
        if (r(this, v).disableRemotePlayback) throw new Et("disableRemotePlayback attribute is present.");
        if (!((n = (s = globalThis.chrome) == null ? void 0 : s.cast) != null && n.isAvailable)) throw new zt("The RemotePlayback API is disabled on this platform.");
        let t = q.has(r(this, v));
        q.add(r(this, v)), me(r(this, v).castOptions), Object.entries(r(this, V)).forEach(([d, T])=>{
            r(this, M).controller.addEventListener(d, T);
        });
        try {
            await U().requestSession();
        } catch (d) {
            if (d === "cancel") {
                t || q.delete(r(this, v));
                return;
        ...
        (m = (l = D.get(r(this, v))) == null ? void 0 : l.loadOnPrompt) == null || m.call(l);
    }
};
v = new WeakMap, Nt = new WeakMap, M = new WeakMap, V = new WeakMap, dt = new WeakMap, ct = new WeakMap, Y = new WeakMap, Qt = new WeakMap, _ = new WeakSet, at = function() {
    if (q.has(r(this, v))) return r(this, M);
}, Ye = function() {
    q.has(r(this, v)) && (Object.entries(r(this, V)).forEach(([t, s])=>{
        r(this, M).controller.removeEventListener(t, s);
    }), q.delete(r(this, v)), r(this, v).muted = r(this, M).isMuted, r(this, v).currentTime = r(this, M).savedPlayerState.currentTime, r(this, M).savedPlayerState.isPaused === !1 && r(this, v).play());
}, ge = function() {
    let t = U().getCastState();
    if (q.has(r(this, v)) && t === "CONNECTING" && (u(this, dt, "connecting"), this.dispatchEvent(new Event("connecting"))), !r(this, ct) && t != null && t.includes("CONNECT")) {
        u(this, ct, !0);
        for (let s of r(this, Y))s(!0);
    } else if (r(this, ct) && (!t || t === "NO_DEVICES_AVAILABLE")) {
        u(this, ct, !1);
        for (let s of r(this, Y))s(!1);
    }
}, He = async function() {
    var s;
    let { SESSION_RESUMED: t } = L.SessionState;
    if (U().getSessionState() === t && r(this, v).castSrc === ((s = Xt()) == null ? void 0 : s.media.contentId)) {
        q.add(r(this, v)), Object.entries(r(this, V)).forEach(([n, l])=>{
            r(this, M).controller.addEventListener(n, l);
        });
        try {
            await Be(new chrome.cast.media.GetStatusRequest);
        } catch (n) {
            console.error(n);
        }
        r(this, V)[L.RemotePlayerEventType.IS_PAUSED_CHANGED](), r(this, V)[L.RemotePlayerEventType.PLAYER_STATE_CHANGED]();
    }
}, Ee = function() {
    !L || r(this, Nt) || (u(this, Nt, !0), me(r(this, v).castOptions), r(this, v).textTracks.addEventListener("change", ()=>y(this, _, Te).call(this)), y(this, _, ge).call(this), u(this, M, new L.RemotePlayer), new L.RemotePlayerController(r(this, M)), u(this, V, {
        [L.RemotePlayerEventType.IS_CONNECTED_CHANGED]: ({ value: t })=>{
            t === !0 ? (u(this, dt, "connected"), this.dispatchEvent(new Event("connect"))) : (y(this, _, Ye).call(this), u(this, dt, "disconnected"), this.dispatchEvent(new Event("disconnect")));
        },
        [L.RemotePlayerEventType.DURATION_CHANGED]: ()=>{
            r(this, v).dispatchEvent(new Event("durationchange"));
        },
        [L.RemotePlayerEventType.VOLUME_LEVEL_CHANGED]: ()=>{
            r(this, v).dispatchEvent(new Event("volumechange"));
        },
        [L.RemotePlayerEventType.IS_MUTED_CHANGED]: ()=>{
            r(this, v).dispatchEvent(new Event("volumechange"));
        },
        [L.RemotePlayerEventType.CURRENT_TIME_CHANGED]: ()=>{
            var t;
            (t = r(this, _, at)) != null && t.isMediaLoaded && r(this, v).dispatchEvent(new Event("timeupdate"));
        },
        [L.RemotePlayerEventType.VIDEO_INFO_CHANGED]: ()=>{
            r(this, v).dispatchEvent(new Event("resize"));
        },
        [L.RemotePlayerEventType.IS_PAUSED_CHANGED]: ()=>{
            r(this, v).dispatchEvent(new Event(this.paused ? "pause" : "play"));
        },
        [L.RemotePlayerEventType.PLAYER_STATE_CHANGED]: ()=>{
            var t, s;
            ((t = r(this, _, at)) == null ? void 0 : t.playerState) !== chrome.cast.media.PlayerState.PAUSED && r(this, v).dispatchEvent(new Event({
                [chrome.cast.media.PlayerState.PLAYING]: "playing",
                [chrome.cast.media.PlayerState.BUFFERING]: "waiting",
                [chrome.cast.media.PlayerState.IDLE]: "emptied"
            }[(s = r(this, _, at)) == null ? void 0 : s.playerState]));
        },
        [L.RemotePlayerEventType.IS_MEDIA_LOADED_CHANGED]: async ()=>{
            var t;
            (t = r(this, _, at)) != null && t.isMediaLoaded && (await Promise.resolve(), y(this, _, We).call(this));
        }
    }));
}, We = function() {
    y(this, _, Te).call(this);
}, Te = async function() {
    var a, p, R, k, st;
    if (!r(this, _, at)) return;
    let s = ((p = (a = r(this, M).mediaInfo) == null ? void 0 : a.tracks) != null ? p : []).filter(({ type: C })=>C === chrome.cast.media.TrackType.TEXT), n = [
        ...r(this, v).textTracks
    ].filter(({ kind: C })=>C === "subtitles" || C === "captions"), l = s.map(({ language: C, name: nt, trackId: O })=>{
        var x;
        let { mode: K } = (x = n.find((ve)=>ve.language === C && ve.label === nt)) != null ? x : {};
        return K ? {
            mode: K,
            trackId: O
        } : !1;
    }).filter(Boolean), d = l.filter(({ mode: C })=>C !== "showing").map(({ trackId: C })=>C), T = l.find(({ mode: C })=>C === "showing"), w = (st = (k = (R = wt()) == null ? void 0 : R.getSessionObj().media[0]) == null ? void 0 : k.activeTrackIds) != null ? st : [], B = w;
    if (w.length && (B = B.filter((C)=>!d.includes(C))), T != null && T.trackId && (B = [
        ...B,
        T.trackId
    ]), B = [
        ...new Set(B)
    ], !((C, nt)=>C.length === nt.length && C.every((O)=>nt.includes(O)))(w, B)) try {
        let C = new chrome.cast.media.EditTracksInfoRequest(B);
        await Ge(C);
    } catch (C) {
        console.error(C);
    }
...
var je = (e)=>{
    ...
    return t = class extends e {
        ...
        get remote() {
            return r(this, m) ? r(this, m) : Ve() ? (this.disableRemotePlayback || Fe(), D.set(this, {
                loadOnPrompt: ()=>y(this, d, $e).call(this)
            }), u(this, m, new Zt(this))) : super.remote;
        }
        attributeChangedCallback(a, p, R) {
            if (super.attributeChangedCallback(a, p, R), a === "cast-receiver" && R) {
                r(this, n).receiverApplicationId = R;
                return;
            }
            if (r(this, d, b)) switch(a){
        ...
        async load() {
            var C, nt;
            if (!r(this, d, b)) return super.load();
            let a = new chrome.cast.media.MediaInfo(this.castSrc, this.castContentType);
            a.customData = this.castCustomData;
            let p = [
                ...this.querySelectorAll("track")
            ].filter(({ kind: O, src: K })=>K && (O === "subtitles" || O === "captions")), R = [], k = 0;
            if (p.length && (a.tracks = p.map((O)=>{
                let K = ++k;
                R.length === 0 && O.track.mode === "showing" && R.push(K);
                let x = new chrome.cast.media.Track(K, chrome.cast.media.TrackType.TEXT);
                return x.trackContentId = O.src, x.trackContentType = "text/vtt", x.subtype = O.kind === "captions" ? chrome.cast.media.TextTrackType.CAPTIONS : chrome.cast.media.TextTrackType.SUBTITLES, x.name = O.label, x.language = O.srclang, x;
            })), this.castStreamType === "live" ? a.streamType = chrome.cast.media.StreamType.LIVE : a.streamType = chrome.cast.media.StreamType.BUFFERED, a.metadata = new chrome.cast.media.GenericMediaMetadata, a.metadata.title = this.title, a.metadata.images = [
                {
                    url: this.poster
                }
            ], Ke(this.castSrc)) {
                let O = await Ue(this.castSrc);
                ((O == null ? void 0 : O.includes("m4s")) || (O == null ? void 0 : O.includes("mp4"))) && (a.hlsSegmentFormat = chrome.cast.media.HlsSegmentFormat.FMP4, a.hlsVideoSegmentFormat = chrome.cast.media.HlsVideoSegmentFormat.FMP4);
            }
            let st = new chrome.cast.media.LoadRequest(a);
            st.currentTime = (C = super.currentTime) != null ? C : 0, st.autoplay = !r(this, s).paused, st.activeTrackIds = R, await ((nt = wt()) == null ? void 0 : nt.loadMedia(st)), this.dispatchEvent(new Event("volumechange"));
        }
        play() {
            var a;
            if (r(this, d, b)) {
                r(this, d, b).isPaused && ((a = r(this, d, b).controller) == null || a.playOrPause());
                return;
            }
            return super.play();
        }
        ...
        get castReceiver() {
            var a;
            return (a = this.getAttribute("cast-receiver")) != null ? a : void 0;
        }
        set castReceiver(a) {
        ...
        get castSrc() {
            var a, p, R;
            return (R = (p = this.getAttribute("cast-src")) != null ? p : (a = this.querySelector("source")) == null ? void 0 : a.src) != null ? R : this.currentSrc;
        }
        set castSrc(a) {
        ...
        get castContentType() {
            var a;
            return (a = this.getAttribute("cast-content-type")) != null ? a : void 0;
        }
        ...
        get castStreamType() {
            var a, p;
            return (p = (a = this.getAttribute("cast-stream-type")) != null ? a : this.streamType) != null ? p : void 0;
        }
        ...
        set castCustomData(a) {
            ...
            if (![
                ...
                console.error(`castCustomData must be nullish or an object but value was of type ${p}`);
                return;
            }
            u(this, l, a);
        }
        get readyState() {
            if (r(this, d, b)) switch(r(this, d, b).playerState){
        ...
        get paused() {
            return r(this, d, b) ? r(this, d, b).isPaused : super.paused;
        }
        get muted() {
            var a;
            return r(this, d, b) ? (a = r(this, d, b)) == null ? void 0 : a.isMuted : super.muted;
        }
        set muted(a) {
            var p;
            if (r(this, d, b)) {
                (a && !r(this, d, b).isMuted || !a && r(this, d, b).isMuted) && ((p = r(this, d, b).controller) == null || p.muteOrUnmute());
                return;
            }
            super.muted = a;
        }
        get volume() {
            var a, p;
            return r(this, d, b) ? (p = (a = r(this, d, b)) == null ? void 0 : a.volumeLevel) != null ? p : 1 : super.volume;
        }
        set volume(a) {
            var p;
            if (r(this, d, b)) {
                r(this, d, b).volumeLevel = +a, (p = r(this, d, b).controller) == null || p.setVolumeLevel();
                return;
            }
            super.volume = a;
        }
        get duration() {
            var a, p, R;
            return r(this, d, b) && (a = r(this, d, b)) != null && a.isMediaLoaded ? (R = (p = r(this, d, b)) == null ? void 0 : p.duration) != null ? R : NaN : super.duration;
        }
        get currentTime() {
            var a, p, R;
            return r(this, d, b) && (a = r(this, d, b)) != null && a.isMediaLoaded ? (R = (p = r(this, d, b)) == null ? void 0 : p.currentTime) != null ? R : 0 : super.currentTime;
        }
        set currentTime(a) {
            var p;
            if (r(this, d, b)) {
                r(this, d, b).currentTime = a, (p = r(this, d, b).controller) == null || p.seek();
                return;
            }
            super.currentTime = a;
        }
    }, s = new WeakMap, n = new WeakMap, l = new WeakMap, m = new WeakMap, d = new WeakSet, b = function() {
        var a, p;
        return (p = (a = D.get(this.remote)) == null ? void 0 : a.getCastPlayer) == null ? void 0 : p.call(a);
    }, $e = async function() {
        r(this, s).paused = Wt(t.prototype, this, "paused"), Wt(t.prototype, this, "pause").call(this), this.muted = Wt(t.prototype, this, "muted");
        try {
            await this.load();
        } catch (a) {
            console.error(a);
        }
    }, E(t, "observedAttributes", [
        ...(i = e.observedAttributes) != null ? i : [],
        "cast-src",
        "cast-content-type",
        "cast-stream-type",
        "cast-receiver"
...
function c(e) {
    var i;
    return (i = be.get(e)) != null ? i : Ri(e, {});
}
function Ri(e, i) {
    let t = be.get(e);
    return t || be.set(e, t = {}), Object.assign(t, i);
}
function te(e, i) {
    let t = e.videoTracks;
    c(i).media = e, c(i).renditionSet || (c(i).renditionSet = new Set);
    let s = c(t).trackSet;
    s.add(i);
    let n = s.size - 1;
    n in ht.prototype || Object.defineProperty(ht.prototype, n, {
        get () {
            return [
                ...c(this).trackSet
            ][n];
        ...
        t.dispatchEvent(new F("addtrack", {
            track: i
        }));
    });
}
function ee(e) {
    var s;
    let i = (s = c(e).media) == null ? void 0 : s.videoTracks;
    if (!i) return;
    c(i).trackSet.delete(e), queueMicrotask(()=>{
        i.dispatchEvent(new F("removetrack", {
            track: e
        }));
    });
}
function ze(e) {
    var s;
    let i = (s = c(e).media.videoTracks) != null ? s : [], t = !1;
    for (let n of i)n !== e && (n.selected = !1, t = !0);
    if (t) {
        if (c(i).changeRequested) return;
        c(i).changeRequested = !0, queueMicrotask(()=>{
            delete c(i).changeRequested, i.dispatchEvent(new Event("change"));
        });
    }
}
var H, W, j, ut, xt, ht = class extends EventTarget {
    constructor(){
        super();
        h(this, ut);
        h(this, H);
        h(this, W);
        h(this, j);
        c(this).trackSet = new Set;
    }
    [Symbol.iterator]() {
        return r(this, ut, xt).values();
    }
    get length() {
        return r(this, ut, xt).size;
    }
    getTrackById(t) {
        var s;
        return (s = [
            ...r(this, ut, xt)
        ].find((n)=>n.id === t)) != null ? s : null;
    }
    get selectedIndex() {
        return [
            ...r(this, ut, xt)
    ...
    set onaddtrack(t) {
        r(this, H) && (this.removeEventListener("addtrack", r(this, H)), u(this, H, void 0)), typeof t == "function" && (u(this, H, t), this.addEventListener("addtrack", t));
    }
    get onremovetrack() {
        return r(this, W);
    }
    set onremovetrack(t) {
        r(this, W) && (this.removeEventListener("removetrack", r(this, W)), u(this, W, void 0)), typeof t == "function" && (u(this, W, t), this.addEventListener("removetrack", t));
    }
    get onchange() {
        return r(this, j);
    }
    set onchange(t) {
        r(this, j) && (this.removeEventListener("change", r(this, j)), u(this, j, void 0)), typeof t == "function" && (u(this, j, t), this.addEventListener("change", t));
    }
};
H = new WeakMap, W = new WeakMap, j = new WeakMap, ut = new WeakSet, xt = function() {
...
function Xe(e, i) {
    let t = c(e).media.videoRenditions;
    c(i).media = c(e).media, c(i).track = e;
    let s = c(e).renditionSet;
    s.add(i);
    let n = s.size - 1;
    n in lt.prototype || Object.defineProperty(lt.prototype, n, {
        get () {
            return Tt(this)[n];
        }
    }), queueMicrotask(()=>{
        e.selected && t.dispatchEvent(new G("addrendition", {
            rendition: i
        }));
    });
}
function Je(e) {
    let i = c(e).media.videoRenditions, t = c(e).track;
    c(t).renditionSet.delete(e), queueMicrotask(()=>{
        c(e).track.selected && i.dispatchEvent(new G("removerendition", {
            rendition: e
        }));
    });
}
function Ze(e) {
    let i = c(e).media.videoRenditions;
    !i || c(i).changeRequested || (c(i).changeRequested = !0, queueMicrotask(()=>{
        delete c(i).changeRequested, c(e).track.selected && i.dispatchEvent(new Event("change"));
    }));
}
function Tt(e) {
    return [
        ...c(e).media.videoTracks
    ].filter((t)=>t.selected).flatMap((t)=>[
            ...c(t).renditionSet
        ]);
}
var $, z, X, lt = class extends EventTarget {
    constructor(){
        super(...arguments);
        h(this, $);
        h(this, z);
    ...
    getRenditionById(t) {
        var s;
        return (s = Tt(this).find((n)=>`${n.id}` == `${t}`)) != null ? s : null;
    }
    get selectedIndex() {
        return Tt(this).findIndex((t)=>t.selected);
    }
    set selectedIndex(t) {
        for (let [s, n] of Tt(this).entries())n.selected = s === t;
    }
    get onaddrendition() {
        return r(this, $);
    }
    set onaddrendition(t) {
        r(this, $) && (this.removeEventListener("addrendition", r(this, $)), u(this, $, void 0)), typeof t == "function" && (u(this, $, t), this.addEventListener("addrendition", t));
    }
    get onremoverendition() {
        return r(this, z);
    }
    set onremoverendition(t) {
        r(this, z) && (this.removeEventListener("removerendition", r(this, z)), u(this, z, void 0)), typeof t == "function" && (u(this, z, t), this.addEventListener("removerendition", t));
    }
    get onchange() {
        return r(this, X);
    }
    set onchange(t) {
        r(this, X) && (this.removeEventListener("change", r(this, X)), u(this, X, void 0)), typeof t == "function" && (u(this, X, t), this.addEventListener("change", t));
    }
};
$ = new WeakMap, z = new WeakMap, X = new WeakMap;
var bt, Dt = class {
    constructor(){
        E(this, "src");
        E(this, "id");
    ...
    set selected(i) {
        r(this, bt) !== i && (u(this, bt, i), Ze(this));
    }
};
bt = new WeakMap;
var yt, vt = class {
    ...
    addRendition(i, t, s, n, l, m) {
        let d = new Dt;
        return d.src = i, d.width = t, d.height = s, d.frameRate = m, d.bitrate = l, d.codec = n, Xe(this, d), d;
    }
    removeRendition(i) {
        Je(i);
    }
    ...
    set selected(i) {
        r(this, yt) !== i && (u(this, yt, i), i === !0 && ze(this));
    }
};
yt = new WeakMap;
function Qe(e, i) {
    let t = c(e).media.audioRenditions;
    c(i).media = c(e).media, c(i).track = e;
    let s = c(e).renditionSet;
    s.add(i);
    let n = s.size - 1;
    n in ft.prototype || Object.defineProperty(ft.prototype, n, {
        get () {
            return At(this)[n];
        }
    }), queueMicrotask(()=>{
        e.enabled && t.dispatchEvent(new G("addrendition", {
            rendition: i
        }));
    });
}
function ti(e) {
    let i = c(e).media.audioRenditions, t = c(e).track;
    c(t).renditionSet.delete(e), queueMicrotask(()=>{
        c(e).track.enabled && i.dispatchEvent(new G("removerendition", {
            rendition: e
        }));
    });
}
function ei(e) {
    let i = c(e).media.audioRenditions;
    !i || c(i).changeRequested || (c(i).changeRequested = !0, queueMicrotask(()=>{
        delete c(i).changeRequested, c(e).track.enabled && i.dispatchEvent(new Event("change"));
    }));
}
function At(e) {
    return [
        ...c(e).media.audioTracks
    ].filter((t)=>t.enabled).flatMap((t)=>[
            ...c(t).renditionSet
        ]);
}
var J, Z, Q, ft = class extends EventTarget {
    constructor(){
        super(...arguments);
        h(this, J);
        h(this, Z);
    ...
    getRenditionById(t) {
        var s;
        return (s = At(this).find((n)=>`${n.id}` == `${t}`)) != null ? s : null;
    }
    get selectedIndex() {
        return At(this).findIndex((t)=>t.selected);
    }
    set selectedIndex(t) {
        for (let [s, n] of At(this).entries())n.selected = s === t;
    }
    get onaddrendition() {
        return r(this, J);
    }
    set onaddrendition(t) {
        r(this, J) && (this.removeEventListener("addrendition", r(this, J)), u(this, J, void 0)), typeof t == "function" && (u(this, J, t), this.addEventListener("addrendition", t));
    }
    get onremoverendition() {
        return r(this, Z);
    }
    ...
    set onchange(t) {
        r(this, Q) && (this.removeEventListener("change", r(this, Q)), u(this, Q, void 0)), typeof t == "function" && (u(this, Q, t), this.addEventListener("change", t));
    }
};
J = new WeakMap, Z = new WeakMap, Q = new WeakMap;
var kt, Vt = class {
    constructor(){
        E(this, "src");
        E(this, "id");
    ...
    set selected(i) {
        r(this, kt) !== i && (u(this, kt, i), ei(this));
    }
};
kt = new WeakMap;
function re(e, i) {
    ...
    s.add(i);
    let n = s.size - 1;
    n in mt.prototype || Object.defineProperty(mt.prototype, n, {
        get () {
            return [
                ...c(this).trackSet
            ][n];
...
function se(e) {
    var s;
    let i = (s = c(e).media) == null ? void 0 : s.audioTracks;
    if (!i) return;
    c(i).trackSet.delete(e), queueMicrotask(()=>{
        i.dispatchEvent(new F("removetrack", {
            track: e
...
function ii(e) {
    let i = c(e).media.audioTracks;
    !i || c(i).changeRequested || (c(i).changeRequested = !0, queueMicrotask(()=>{
        delete c(i).changeRequested, i.dispatchEvent(new Event("change"));
    }));
}
var tt, et, it, St, ie, mt = class extends EventTarget {
    constructor(){
        super();
        h(this, St);
        h(this, tt);
    ...
    [Symbol.iterator]() {
        return r(this, St, ie).values();
    }
    get length() {
        return r(this, St, ie).size;
    }
    getTrackById(t) {
        var s;
        return (s = [
    ...
    set onaddtrack(t) {
        r(this, tt) && (this.removeEventListener("addtrack", r(this, tt)), u(this, tt, void 0)), typeof t == "function" && (u(this, tt, t), this.addEventListener("addtrack", t));
    }
    get onremovetrack() {
        return r(this, et);
    }
    set onremovetrack(t) {
        r(this, et) && (this.removeEventListener("removetrack", r(this, et)), u(this, et, void 0)), typeof t == "function" && (u(this, et, t), this.addEventListener("removetrack", t));
    }
    get onchange() {
        return r(this, it);
    }
    set onchange(t) {
        r(this, it) && (this.removeEventListener("change", r(this, it)), u(this, it, void 0)), typeof t == "function" && (u(this, it, t), this.addEventListener("change", t));
    }
};
tt = new WeakMap, et = new WeakMap, it = new WeakMap, St = new WeakSet, ie = function() {
    return c(this).trackSet;
};
var Rt, Ct = class {
    constructor(){
    ...
    addRendition(i, t, s) {
        let n = new Vt;
        return n.src = i, n.codec = t, n.bitrate = s, Qe(this, n), n;
    }
    removeRendition(i) {
        ti(i);
    }
    ...
    set enabled(i) {
        r(this, Rt) !== i && (u(this, Rt, i), ii(this));
    }
};
Rt = new WeakMap;
var ri = ne(globalThis.HTMLMediaElement, "video"), si = ne(globalThis.HTMLMediaElement, "audio");
function ni(e) {
    if (!(e != null && e.prototype)) return e;
    let i = ne(e, "video");
    (!i || `${i}`.includes("[native code]")) && Object.defineProperty(e.prototype, "videoTracks", {
        get () {
            return Ci(this);
        }
    });
    let t = ne(e, "audio");
    (!t || `${t}`.includes("[native code]")) && Object.defineProperty(e.prototype, "audioTracks", {
        get () {
            return _i(this);
        }
    }), "addVideoTrack" in e.prototype || (e.prototype.addVideoTrack = function(l, m = "", d = "") {
        let T = new vt;
        return T.kind = l, T.label = m, T.language = d, te(this, T), T;
    }), "removeVideoTrack" in e.prototype || (e.prototype.removeVideoTrack = ee), "addAudioTrack" in e.prototype || (e.prototype.addAudioTrack = function(l, m = "", d = "") {
        let T = new Ct;
        return T.kind = l, T.label = m, T.language = d, re(this, T), T;
    }), "removeAudioTrack" in e.prototype || (e.prototype.removeAudioTrack = se), "videoRenditions" in e.prototype || Object.defineProperty(e.prototype, "videoRenditions", {
        get () {
            return s(this);
        }
    });
    let s = (l)=>{
        let m = c(l).videoRenditions;
        return m || (m = new lt, c(m).media = l, c(l).videoRenditions = m), m;
    };
    ...
    let n = (l)=>{
        let m = c(l).audioRenditions;
        return m || (m = new ft, c(m).media = l, c(l).audioRenditions = m), m;
    };
    return e;
}
function ne(e, i) {
    var t;
    if (e != null && e.prototype) return (t = Object.getOwnPropertyDescriptor(e.prototype, `${i}Tracks`)) == null ? void 0 : t.get;
}
function Ci(e) {
    var t;
    let i = c(e).videoTracks;
    if (!i && (i = new ht, c(e).videoTracks = i, ri)) {
        let s = ri.call((t = e.nativeEl) != null ? t : e);
        for (let n of s)te(e, n);
        s.addEventListener("change", ()=>{
            i.dispatchEvent(new Event("change"));
        }), s.addEventListener("addtrack", (n)=>{
            if ([
                ...i
            ].some((l)=>l instanceof vt)) {
                for (let l of s)ee(l);
                return;
            }
            te(e, n.track);
...
function _i(e) {
    var t;
    let i = c(e).audioTracks;
    if (!i && (i = new mt, c(e).audioTracks = i, si)) {
        let s = si.call((t = e.nativeEl) != null ? t : e);
        for (let n of s)re(e, n);
        s.addEventListener("change", ()=>{
            i.dispatchEvent(new Event("change"));
        }), s.addEventListener("addtrack", (n)=>{
            if ([
                ...i
            ].some((l)=>l instanceof Ct)) {
                for (let l of s)se(l);
                return;
            }
            re(e, n.track);
...
fe.push("castchange", "entercast", "leavecast");
var o = {
    ...
    TYPE: "type"
}, $i = Object.values(o), ai = Re(), di = "mux-video", N, _t, Gt, Pt, Bt, Kt, Ut, qt, Yt, It, ae, ye = class extends $t {
    constructor(){
        super();
        h(this, It);
        h(this, N);
        ...
        h(this, qt);
        h(this, Yt);
        u(this, Gt, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$mux$2d$video$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["generatePlayerInitTime"])());
    }
    static get NAME() {
        return di;
    }
    ...
    static get observedAttributes() {
        ...
        return [
            ...$i,
            ...(t = $t.observedAttributes) != null ? t : []
        ];
    }
    get preferCmcd() {
        var t;
        return (t = this.getAttribute(o.PREFER_CMCD)) != null ? t : void 0;
    }
    set preferCmcd(t) {
        t !== this.preferCmcd && (t ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$mux$2d$video$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["CmcdTypeValues"].includes(t) ? this.setAttribute(o.PREFER_CMCD, t) : console.warn(`Invalid value for preferCmcd. Must be one of ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$mux$2d$video$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["CmcdTypeValues"].join()}`) : this.removeAttribute(o.PREFER_CMCD));
    }
    get playerInitTime() {
        return this.hasAttribute(o.PLAYER_INIT_TIME) ? +this.getAttribute(o.PLAYER_INIT_TIME) : r(this, Gt);
    }
    set playerInitTime(t) {
        t != this.playerInitTime && (t == null ? this.removeAttribute(o.PLAYER_INIT_TIME) : this.setAttribute(o.PLAYER_INIT_TIME, `${+t}`));
    }
    get playerSoftwareName() {
        var t;
        return (t = r(this, qt)) != null ? t : di;
    }
    ...
    get _hls() {
        var t;
        return (t = r(this, N)) == null ? void 0 : t.engine;
    }
    get mux() {
        var t;
    ...
    get type() {
        var t;
        return (t = this.getAttribute(o.TYPE)) != null ? t : void 0;
    }
    set type(t) {
        t !== this.type && (t ? this.setAttribute(o.TYPE, t) : this.removeAttribute(o.TYPE));
    }
    get autoplay() {
    ...
    set autoplay(t) {
        let s = this.autoplay;
        t !== s && (t ? this.setAttribute("autoplay", typeof t == "string" ? t : "") : this.removeAttribute("autoplay"));
    }
    get preload() {
    ...
    set debug(t) {
        t !== this.debug && (t ? this.setAttribute(o.DEBUG, "") : this.removeAttribute(o.DEBUG));
    }
    get disableTracking() {
        return this.hasAttribute(o.DISABLE_TRACKING);
    }
    set disableTracking(t) {
        t !== this.disableTracking && this.toggleAttribute(o.DISABLE_TRACKING, !!t);
    }
    get disableCookies() {
        return this.hasAttribute(o.DISABLE_COOKIES);
    }
    set disableCookies(t) {
        t !== this.disableCookies && (t ? this.setAttribute(o.DISABLE_COOKIES, "") : this.removeAttribute(o.DISABLE_COOKIES));
    }
    get startTime() {
        let t = this.getAttribute(o.START_TIME);
        if (t == null) return;
        let s = +t;
        return Number.isNaN(s) ? void 0 : s;
    }
    set startTime(t) {
        t !== this.startTime && (t == null ? this.removeAttribute(o.START_TIME) : this.setAttribute(o.START_TIME, `${t}`));
    }
    get playbackId() {
        var t;
        return this.hasAttribute(o.PLAYBACK_ID) ? this.getAttribute(o.PLAYBACK_ID) : (t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$mux$2d$video$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["toPlaybackIdFromSrc"])(this.src)) != null ? t : void 0;
    }
    set playbackId(t) {
        t !== this.playbackId && (t ? this.setAttribute(o.PLAYBACK_ID, t) : this.removeAttribute(o.PLAYBACK_ID));
    }
    get maxResolution() {
        var t;
        return (t = this.getAttribute(o.MAX_RESOLUTION)) != null ? t : void 0;
    }
    set maxResolution(t) {
        t !== this.maxResolution && (t ? this.setAttribute(o.MAX_RESOLUTION, t) : this.removeAttribute(o.MAX_RESOLUTION));
    }
    get minResolution() {
        var t;
        return (t = this.getAttribute(o.MIN_RESOLUTION)) != null ? t : void 0;
    }
    set minResolution(t) {
        t !== this.minResolution && (t ? this.setAttribute(o.MIN_RESOLUTION, t) : this.removeAttribute(o.MIN_RESOLUTION));
    }
    get renditionOrder() {
        var t;
        return (t = this.getAttribute(o.RENDITION_ORDER)) != null ? t : void 0;
    }
    set renditionOrder(t) {
        t !== this.renditionOrder && (t ? this.setAttribute(o.RENDITION_ORDER, t) : this.removeAttribute(o.RENDITION_ORDER));
    }
    get programStartTime() {
        let t = this.getAttribute(o.PROGRAM_START_TIME);
        if (t == null) return;
        let s = +t;
        return Number.isNaN(s) ? void 0 : s;
    }
    set programStartTime(t) {
        t == null ? this.removeAttribute(o.PROGRAM_START_TIME) : this.setAttribute(o.PROGRAM_START_TIME, `${t}`);
    }
    get programEndTime() {
        let t = this.getAttribute(o.PROGRAM_END_TIME);
        if (t == null) return;
        let s = +t;
        return Number.isNaN(s) ? void 0 : s;
    }
    set programEndTime(t) {
        t == null ? this.removeAttribute(o.PROGRAM_END_TIME) : this.setAttribute(o.PROGRAM_END_TIME, `${t}`);
    }
    get assetStartTime() {
        let t = this.getAttribute(o.ASSET_START_TIME);
        if (t == null) return;
        let s = +t;
        return Number.isNaN(s) ? void 0 : s;
    }
    set assetStartTime(t) {
        t == null ? this.removeAttribute(o.ASSET_START_TIME) : this.setAttribute(o.ASSET_START_TIME, `${t}`);
    }
    get assetEndTime() {
        let t = this.getAttribute(o.ASSET_END_TIME);
        if (t == null) return;
        let s = +t;
        return Number.isNaN(s) ? void 0 : s;
    }
    set assetEndTime(t) {
        t == null ? this.removeAttribute(o.ASSET_END_TIME) : this.setAttribute(o.ASSET_END_TIME, `${t}`);
    }
    get customDomain() {
        var t;
        return (t = this.getAttribute(o.CUSTOM_DOMAIN)) != null ? t : void 0;
    }
    set customDomain(t) {
        t !== this.customDomain && (t ? this.setAttribute(o.CUSTOM_DOMAIN, t) : this.removeAttribute(o.CUSTOM_DOMAIN));
    }
    get drmToken() {
        var t;
        return (t = this.getAttribute(o.DRM_TOKEN)) != null ? t : void 0;
    }
    set drmToken(t) {
        t !== this.drmToken && (t ? this.setAttribute(o.DRM_TOKEN, t) : this.removeAttribute(o.DRM_TOKEN));
    }
    get playbackToken() {
        var t, s, n, l;
        if (this.hasAttribute(o.PLAYBACK_TOKEN)) return (t = this.getAttribute(o.PLAYBACK_TOKEN)) != null ? t : void 0;
        if (this.hasAttribute(o.PLAYBACK_ID)) {
            let [, m] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$mux$2d$video$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["toPlaybackIdParts"])((s = this.playbackId) != null ? s : "");
            return (n = new URLSearchParams(m).get("token")) != null ? n : void 0;
        }
        if (this.src) return (l = new URLSearchParams(this.src).get("token")) != null ? l : void 0;
    }
    set playbackToken(t) {
        t !== this.playbackToken && (t ? this.setAttribute(o.PLAYBACK_TOKEN, t) : this.removeAttribute(o.PLAYBACK_TOKEN));
    }
    get tokens() {
        let t = this.getAttribute(o.PLAYBACK_TOKEN), s = this.getAttribute(o.DRM_TOKEN);
        return {
            ...r(this, Bt),
            ...t != null ? {
                playback: t
    ...
    get envKey() {
        var t;
        return (t = this.getAttribute(o.ENV_KEY)) != null ? t : void 0;
    }
    set envKey(t) {
        t !== this.envKey && (t ? this.setAttribute(o.ENV_KEY, t) : this.removeAttribute(o.ENV_KEY));
    }
    get beaconCollectionDomain() {
        var t;
        return (t = this.getAttribute(o.BEACON_COLLECTION_DOMAIN)) != null ? t : void 0;
    }
    set beaconCollectionDomain(t) {
        t !== this.beaconCollectionDomain && (t ? this.setAttribute(o.BEACON_COLLECTION_DOMAIN, t) : this.removeAttribute(o.BEACON_COLLECTION_DOMAIN));
    }
    get streamType() {
        var t;
        return (t = this.getAttribute(o.STREAM_TYPE)) != null ? t : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$mux$2d$video$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getStreamType"])(this.nativeEl);
    }
    set streamType(t) {
        t !== this.streamType && (t ? this.setAttribute(o.STREAM_TYPE, t) : this.removeAttribute(o.STREAM_TYPE));
    }
    get targetLiveWindow() {
        return this.hasAttribute(o.TARGET_LIVE_WINDOW) ? +this.getAttribute(o.TARGET_LIVE_WINDOW) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$mux$2d$video$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getTargetLiveWindow"])(this.nativeEl);
    }
    set targetLiveWindow(t) {
        t != this.targetLiveWindow && (t == null ? this.removeAttribute(o.TARGET_LIVE_WINDOW) : this.setAttribute(o.TARGET_LIVE_WINDOW, `${+t}`));
    }
    get liveEdgeStart() {
        var t, s;
        if (this.hasAttribute(o.LIVE_EDGE_OFFSET)) {
            let { liveEdgeOffset: n } = this, l = (t = this.nativeEl.seekable.end(0)) != null ? t : 0, m = (s = this.nativeEl.seekable.start(0)) != null ? s : 0;
            return Math.max(m, l - n);
        }
    ...
    get liveEdgeOffset() {
        if (this.hasAttribute(o.LIVE_EDGE_OFFSET)) return +this.getAttribute(o.LIVE_EDGE_OFFSET);
    }
    set liveEdgeOffset(t) {
        t != this.liveEdgeOffset && (t == null ? this.removeAttribute(o.LIVE_EDGE_OFFSET) : this.setAttribute(o.LIVE_EDGE_OFFSET, `${+t}`));
    }
    get seekable() {
    ...
    get preferPlayback() {
        let t = this.getAttribute(o.PREFER_PLAYBACK);
    ...
    set preferPlayback(t) {
        t !== this.preferPlayback && (t === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$mux$2d$video$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["PlaybackTypes"].MSE || t === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$mux$2d$video$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["PlaybackTypes"].NATIVE ? this.setAttribute(o.PREFER_PLAYBACK, t) : this.removeAttribute(o.PREFER_PLAYBACK));
    }
    get metadata() {
        return {
            ...this.getAttributeNames().filter((s)=>s.startsWith("metadata-") && ![
                    o.METADATA_URL
                ].includes(s)).reduce((s, n)=>{
                let l = this.getAttribute(n);
                return l != null && (s[n.replace(/^metadata-/, "").replace(/-/g, "_")] = l), s;
            }, {}),
            ...r(this, Pt)
        };
    }
    set metadata(t) {
        u(this, Pt, t != null ? t : {}), this.mux && this.mux.emit("hb", r(this, Pt));
    }
    get _hlsConfig() {
        return r(this, Kt);
    }
    ...
    load() {
        u(this, N, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$mux$2d$video$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["initialize"])(this, this.nativeEl, r(this, N)));
    }
    unload() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$mux$2d$video$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["teardown"])(this.nativeEl, r(this, N)), u(this, N, void 0);
    }
    attributeChangedCallback(t, s, n) {
        var m, d;
        switch($t.observedAttributes.includes(t) && ![
            "src",
            "autoplay",
            "preload"
        ].includes(t) && super.attributeChangedCallback(t, s, n), t){
            case o.PLAYER_SOFTWARE_NAME:
                this.playerSoftwareName = n != null ? n : void 0;
                break;
            case o.PLAYER_SOFTWARE_VERSION:
                this.playerSoftwareVersion = n != null ? n : void 0;
                break;
            case "src":
                {
                    let T = !!s, w = !!n;
                    !T && w ? y(this, It, ae).call(this) : T && !w ? this.unload() : T && w && (this.unload(), y(this, It, ae).call(this));
                    break;
                }
            case "autoplay":
                if (n === s) break;
                (m = r(this, N)) == null || m.setAutoplay(this.autoplay);
                break;
            case "preload":
                if (n === s) break;
                (d = r(this, N)) == null || d.setPreload(n);
                break;
            case o.PLAYBACK_ID:
            ...
            case o.DEBUG:
                {
                    let T = this.debug;
                    this.mux && console.info("Cannot toggle debug mode of mux data after initialization. Make sure you set all metadata to override before setting the src."), this._hls && (this._hls.config.debug = T);
                    break;
                }
            case o.METADATA_URL:
                n && fetch(n).then((T)=>T.json()).then((T)=>this.metadata = T).catch(()=>console.error(`Unable to load or parse metadata JSON from metadata-url ${n}!`));
                break;
            case o.STREAM_TYPE:
                (n == null || n !== s) && this.dispatchEvent(new CustomEvent("streamtypechange", {
                    composed: !0,
                    bubbles: !0
                }));
                break;
            case o.TARGET_LIVE_WINDOW:
                (n == null || n !== s) && this.dispatchEvent(new CustomEvent("targetlivewindowchange", {
                    composed: !0,
                    bubbles: !0,
    ...
    connectedCallback() {
        var t;
        (t = super.connectedCallback) == null || t.call(this), this.nativeEl && this.src && !r(this, N) && y(this, It, ae).call(this);
    }
    disconnectedCallback() {
        this.unload();
    }
};
N = new WeakMap, _t = new WeakMap, Gt = new WeakMap, Pt = new WeakMap, Bt = new WeakMap, Kt = new WeakMap, Ut = new WeakMap, qt = new WeakMap, Yt = new WeakMap, It = new WeakSet, ae = async function() {
    r(this, _t) || (await u(this, _t, Promise.resolve()), u(this, _t, null), this.load());
};
var Ht, Ft = class extends je(ni(ye)) {
    constructor(){
        super(...arguments);
        h(this, Ht);
    }
    ...
    get castCustomData() {
        var t;
        return (t = r(this, Ht)) != null ? t : this.muxCastCustomData;
    }
...
Ht = new WeakMap;
jt.customElements.get("mux-video") || (jt.customElements.define("mux-video", Ft), jt.MuxVideoElement = Ft);
var Is = Ft;
;
 //# sourceMappingURL=index.mjs.map
}}),
...
{
__turbopack_esm__({});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$mux$2f$mux$2d$video$2f$node_modules$2f40$mux$2f$playback$2d$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_import__("[project]/node_modules/@mux/mux-video/node_modules/@mux/playback-core/dist/index.mjs [app-client] (ecmascript) <module evaluation>");
...
function A({ react: t, tagName: f, elementClass: r, events: c, displayName: u, toAttributeName: H = S, toAttributeValue: _ = O }) {
    let g = Number.parseInt(t.version) >= 19, m = t.forwardRef((w, d)=>{
        var h, E, v, L, P;
        let i = t.useRef(null), y = t.useRef(new Map), b = {}, T = {}, s = {}, l = {};
        for (let [o, e] of Object.entries(w)){
            if (I.has(o)) {
                s[o] = e;
                continue;
            }
            let n = H((h = N[o]) != null ? h : o);
            if (o in r.prototype && !(o in ((v = (E = globalThis.HTMLElement) == null ? void 0 : E.prototype) != null ? v : {})) && !((L = r.observedAttributes) != null && L.some((p)=>p === n))) {
                l[o] = e;
                continue;
            }
            if (o.startsWith("on")) {
            ...
            let a = _(e);
            n && a != null && (T[n] = String(a), g || (s[n] = a)), n && g && (s[n] = e);
        }
        if (typeof window != "undefined") {
            for(let o in b){
                let e = b[o], n = o.endsWith("Capture"), a = ((P = c == null ? void 0 : c[o]) != null ? P : o.slice(2).toLowerCase()).slice(0, n ? -7 : void 0);
                t.useLayoutEffect({
                    "A.m.useLayoutEffect": ()=>{
                        let p = i == null ? void 0 : i.current;
                        if (!(!p || typeof e != "function")) return p.addEventListener(a, e, n), ({
                            "A.m.useLayoutEffect": ()=>{
                                p.removeEventListener(a, e, n);
                            }
                        })["A.m.useLayoutEffect"];
                    }
                }["A.m.useLayoutEffect"], [
            ...
            t.useLayoutEffect({
                "A.m.useLayoutEffect": ()=>{
                    ...
                    let o = new Map;
                    for(let e in l)M(i.current, e, l[e]), y.current.delete(e), o.set(e, l[e]);
                    for (let [e, n] of y.current)M(i.current, e, void 0);
                    y.current = o;
                }
            }["A.m.useLayoutEffect"]);
        }
        ...
        return t.createElement(f, {
            ...
            ref: t.useCallback({
                "A.m.useCallback": (o)=>{
                    i.current = o, typeof d == "function" ? d(o) : d !== null && (d.current = o);
                }
            }["A.m.useCallback"], [
                d
            ])
    ...
    return m.displayName = u != null ? u : r.name, m;
}
function M(t, f, r) {
    var c, u;
    t[f] = r, r == null && f in ((u = (c = globalThis.HTMLElement) == null ? void 0 : c.prototype) != null ? u : {}) && t.removeAttribute(f);
}
var q = A({
...
function x(t) {
    return k[t] ? k[t] : t.replace(/([A-Z])/g, "-$1").toLowerCase();
}
;
...
//# sourceMappingURL=node_modules_9dcec9._.js.map